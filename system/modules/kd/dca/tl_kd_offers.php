 ...
 * Table tl_kd_offers
 */
$GLOBALS['TL_DCA']['tl_kd_offers'] = array
(
...
//			array('KdHelper', 'showStockMessage')
	...
	(
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_kd_offers']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.gif'
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_kd_offers']['copy'],
				'href'                => 'act=copy',
				'icon'                => 'copy.gif'
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_kd_offers']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_kd_offers']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			),
			'print' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_kd_offers']['print'],
				'href'                => 'key=print',
				'icon'                => 'assets/contao/images/print.gif',
				'button_callback'     => array('tl_kd_offers', 'printBill')
			)
		)
	),
	...
	(
		...
		'date' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_kd_offers']['date'],
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 5,
			'inputType'               => 'text',
