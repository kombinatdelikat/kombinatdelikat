 ...
 * Table tl_opm_bills
 */
$GLOBALS['TL_DCA']['tl_opm_bills'] = array
(
	...
	(
		...
		(
			array('tl_opm_bills', 'checkLocked')
		),
		'sql' => array
		(
			'keys' => array
	...
	(
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_opm_bills']['edit'],
				'href'                => 'table=tl_content',
				'icon'                => 'edit.gif'
			),
			'editheader' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_opm_bills']['editheader'],
				'href'                => 'act=edit',
				'icon'                => 'header.gif'
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_opm_bills']['copy'],
				'href'                => 'act=copy',
				'icon'                => 'copy.gif'
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_opm_bills']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_opm_bills']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			),
			'print' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_opm_bills']['print'],
				'href'                => 'key=print',
				'icon'                => 'assets/contao/images/print.gif',
				'button_callback'     => array('tl_opm_bills', 'printBill')
			)
		)
	),
	...
	(
		...
		'no' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_opm_bills']['no'],
			'exclude'                 => true,
			'search'                  => true,
			'sorting'                 => true,
			'flag'                    => 11,
		...
		'locked' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_opm_bills']['locked'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
		...
		'date' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_opm_bills']['date'],
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 6,
			'inputType'               => 'text',
		...
		'due' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_opm_bills']['due'],
			'exclude'                 => true,
			'inputType'               => 'text',
			'eval'                    => array('mandatory'=>true, 'rgxp'=>'digit', 'tl_class'=> 'w50'),
			'load_callback'           => array(array('tl_opm_bills', 'getDue')),
			'sql'                     => "int(10) unsigned NOT NULL default '0'"
		),
		'customer' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_opm_bills']['customer'],
			'exclude'                 => true,
			'inputType'               => 'select',
		...
		'responsible' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_opm_bills']['responsible'],
			'exclude'                 => true,
			'inputType'               => 'select',
			'foreignKey'              => 'tl_member.id',
			'eval'                    => array('mandatory'=>true, 'chosen'=>true, 'includeBlankOption'=>false, 'tl_class'=>'w50'),
...
class tl_opm_bills extends Backend
{
	...
	public function checkLocked(DataContainer $dc)
	{
		...
		$objBillModel = \develab\opm\Models\Bills::findOneBy('id', \Input::get('id'));
		...
		$GLOBALS['TL_DCA']['tl_opm_bills']['fields']['no']['eval']['readonly'] = $objBillModel->generated ?: $objBillModel->locked;
	}
	...
	public function setLabel($arrRow, $strLabel, DataContainer $dc, $args)
	{
		...
		return vsprintf($GLOBALS['TL_DCA']['tl_opm_bills']['list']['label']['format'], $args);
	}
