...
(
	...
	(
		...
		(
			...
			'cut' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_accounting_correspondence']['cut'],
	...
	(
		...
		'format' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_accounting_correspondence']['format'],
			'exclude'                 => true,
			'search'                  => true,
			'sorting'                 => true,
			'flag'                    => 11,
...
class tl_accounting_correspondence extends Backend
{
	public function setLabel($arrRow, $strLabel, DataContainer $dc, $args)
	{
		...
		return vsprintf($GLOBALS['TL_DCA']['tl_accounting_correspondence']['list']['label']['format'], $args);
	}
	...
	public function printCorrespondence($arrRow, $strHref, $strLabel, $strTitle, $strIcon)
	{
		...
		{
			$objCorrespondence = \develab\accounting\Models\Correspondence::findOneBy('id', \Input::get('id'));
