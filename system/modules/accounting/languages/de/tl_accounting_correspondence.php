 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_accounting_correspondence']['new'] = array('Neues Anschreiben', 'Eine neues Anschreiben anlegen.');
$GLOBALS['TL_LANG']['tl_accounting_correspondence']['show'] = array('Anschreibendetails', 'Details des Anschreibens ID %s anzeigen');
