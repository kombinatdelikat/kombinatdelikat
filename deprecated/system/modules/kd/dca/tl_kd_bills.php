 ...
 * Table tl_kd_bills
 */
$GLOBALS['TL_DCA']['tl_kd_bills'] = array
(
...
//			array('\KombinatDelikat\Classes\Helper', 'showStockMessage')
	...
	(
		...
		(
			...
			'format'                  => '<strong style="text-transform:uppercase">Rechnung %s</strong> vom %s<br><em>Zuletzt bearbeitet am %s Uhr</em>',
			'label_callback'          => array
			(
				'tl_kd_bills', 'setLabel'
			)
		),
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_kd_bills']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.gif'
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_kd_bills']['copy'],
				'href'                => 'act=copy',
				'icon'                => 'copy.gif'
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_kd_bills']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_kd_bills']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			),
			'print' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_kd_bills']['print'],
				'href'                => 'key=print',
				'icon'                => 'assets/contao/images/print.gif',
				'button_callback'     => array('tl_kd_bills', 'printBill')
			)
		)
	),
	...
	(
		...
		'locked' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_kd_labels']['locked'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
		...
		'no' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_kd_labels']['no'],
			'exclude'                 => true,
			'search'                  => true,
			'sorting'                 => true,
			'flag'                    => 11,
		...
		'date' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_kd_bills']['date'],
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 5,
			'inputType'               => 'text',
