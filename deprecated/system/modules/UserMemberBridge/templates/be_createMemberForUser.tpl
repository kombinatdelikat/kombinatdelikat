...
<form action="<?php echo $this->request; ?>" id="tl_member_createMemberForUser" class="tl_form" method="post" enctype="multipart/form-data">
<input type="hidden" name="FORM_SUBMIT" value="tl_member_createMemberForUser" />

<div class="tl_formbody_edit">

<div class="tl_tbox">
  <h3><?php echo $this->user->generateLabel(); ?></h3>
  <?php echo $this->user->generateWithError(); if ($this->user->help): ?> 
	<p class="tl_help tl_tip"><?php echo $this->user->help; ?></p><?php endif; ?> 
</div>
